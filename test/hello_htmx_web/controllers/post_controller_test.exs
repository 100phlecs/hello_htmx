defmodule HelloHtmxWeb.PostControllerTest do
  use HelloHtmxWeb.ConnCase

  import HelloHtmx.ContentFixtures

  @create_attrs %{title: "some title", author: "some author", body: "some body"}
